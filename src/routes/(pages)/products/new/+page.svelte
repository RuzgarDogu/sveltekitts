...
<form action="?/createProduct" method="POST" class="m-3">
	<div class="pt-10 lg:col-span-5 xl:col-span-6 lg:row-start-1 lg:row-end-2">
		...
		>
			<article>
				<h2
					class="text-lg font-semibold text-slate-900 pt-4 pb-2 px-4 sm:px-6 lg:px-4 xl:px-6 dark:text-slate-100 transition-opacity duration-[1.5s] delay-500 opacity-75"
				>
					Create New Product
				</h2>
				<dl
				...
				>
					...
					<ListItem title="Title">
						<Input name="title" size="sm" id="default-input" placeholder="Title" />
					</ListItem>
